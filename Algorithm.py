class CipherMachine:
    def __init__(self):
        ...
        self.bar_setups = [
        {'lug': [1, 0, 0, 1, 0, 0], 'cam': ['A', '0', '0', '0', '0', '0']},
        {'lug': [1, 0, 0, 0, 0, 0], 'cam': ['B', '0', '0', '0', '0', '0']},
        {'lug': [1, 0, 0, 0, 0, 0], 'cam': ['0', 'A', '0', '0', '0', '0']},
        {'lug': [1, 0, 0, 1, 0, 0], 'cam': ['0', 'B', '0', '0', '0', '0']},
        {'lug': [1, 0, 0, 0, 0, 0], 'cam': ['0', '0', 'A', '0', '0', '0']},
        {'lug': [0, 1, 0, 0, 0, 0], 'cam': ['0', '0', 'B', '0', '0', '0']},
        {'lug': [0, 1, 1, 0, 0, 0], 'cam': ['0', '0', '0', 'A', '0', '0']},
        {'lug': [0, 1, 0, 0, 0, 0], 'cam': ['0', '0', '0', 'B', '0', '0']},
        {'lug': [0, 1, 0, 0, 0, 0], 'cam': ['A', '0', '0', '0', 'A', '0']},
        {'lug': [0, 1, 0, 0, 0, 0], 'cam': ['0', '0', '0', '0', 'B', '0']},
        {'lug': [0, 0, 1, 0, 1, 0], 'cam': ['0', '0', '0', '0', '0', 'A']},
        {'lug': [0, 0, 1, 0, 0, 0], 'cam': ['A', '0', '0', '0', '0', 'B']},
        {'lug': [0, 0, 1, 0, 0, 0], 'cam': ['0', '0', '0', '0', '0', '0']},
        {'lug': [1, 0, 1, 0, 0, 0], 'cam': ['A', 'A', 'A', 'A', 'A', 'A']},
        {'lug': [0, 0, 1, 0, 0, 0], 'cam': ['C', 'C', 'C', 'C', 'C', 'C']},
        {'lug': [0, 0, 0, 1, 0, 0], 'cam': ['0', '0', '0', '0', '0', '0']},
        {'lug': [0, 1, 0, 1, 0, 0], 'cam': ['C', '0', '0', '0', '0', '0']},
        {'lug': [0, 0, 0, 1, 0, 0], 'cam': ['0', '0', '0', '0', '0', '0']},
        {'lug': [0, 0, 0, 1, 0, 0], 'cam': ['0', 'A', '0', '0', '0', '0']},
        {'lug': [0, 0, 0, 1, 0, 1], 'cam': ['0', 'A', '0', '0', '0', '0']},
        {'lug': [0, 0, 0, 0, 1, 0], 'cam': ['A', 'A', 'C', 'A', '0', '0']},
        {'lug': [0, 0, 0, 0, 1, 0], 'cam': ['0', '0', 'B', '0', '0', '0']},
        {'lug': [0, 0, 1, 0, 1, 0], 'cam': ['0', '0', 'A', '0', '0', '0']},
        {'lug': [0, 0, 0, 0, 1, 0], 'cam': ['0', '0', '0', '0', '0', '0']},
        {'lug': [0, 0, 0, 0, 1, 0], 'cam': ['0', '0', '0', '0', '0', '0']},
        {'lug': [0, 1, 0, 0, 0, 1], 'cam': ['0', '0', '0', 'A', '0', '0']},
        {'lug': [0, 0, 0, 0, 0, 1], 'cam': ['0', 'C', '0', '0', '0', '0']},
        {'lug': [0, 0, 0, 0, 0, 1], 'cam': ['0', '0', '0', '0', 'A', 'A']},
        {'lug': [0, 0, 0, 0, 0, 1], 'cam': ['0', '0', '0', '0', '0', 'B']},
        {'lug': [0, 0, 0, 0, 0, 1], 'cam': ['0', '0', '0', 'B', '0', '0']},
